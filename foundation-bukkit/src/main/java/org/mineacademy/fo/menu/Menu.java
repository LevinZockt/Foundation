...
public abstract class Menu {
	...
	/**
	 * The inventory title of the menu, MiniMessage tags and legacy colors are supported.
	 * If no color is provided, the title is black.
	 */
	...
	public final void displayTo(final Player player) {
		...
		if (player.isConversing()) {
			Common.tell(player, Lang.component("menu-cannot-open-during-conversation"));
	...
	/*
	 * An internal method to perform the menu restart.
	 */
